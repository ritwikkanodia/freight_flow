import { fetchLoadBoard, ratePerMile, formatUSD, LoadBoardItem } from "@/lib/loads";
  ...
  return (
    <div className="flex flex-col rounded-xl border border-gray-200 bg-white shadow-sm">
      ...
      <div className="flex items-start justify-between gap-3 border-b border-gray-100 p-5">
        ...
        <div className="text-right">
          <div className="text-xl font-semibold text-gray-900">
            {item.price != null ? formatUSD(item.price) : "Call"}
          </div>
          {rpm && <div className="text-xs text-gray-400">{rpm}</div>}
        </div>
      </div>
      ...
      <div className="mt-auto border-t border-gray-100 p-5">
        ...
        <a
          href={item.agent ? `tel:${item.agent.phone}` : undefined}
